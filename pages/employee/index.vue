      ...
      <UCard class="hover:shadow-lg transition-shadow">
        ...
        <div class="space-y-3">
          ...
          <div class="flex justify-between items-center">
            ...
            <span class="text-sm font-medium text-gray-800 dark:text-gray-200">5 / 20</span>
          </div>
      ...
      <UCard class="hover:shadow-lg transition-shadow">
        ...
        <div class="space-y-3">
          ...
          <div class="text-center pt-2">
            <UButton size="xs" color="yellow" variant="soft">View All</UButton>
          </div>
        </div>
      </UCard>
      ...
      <UCard class="hover:shadow-lg transition-shadow">
        <template #header>
          <div class="flex items-center justify-between">
            ...
            <UIcon name="i-heroicons-user-circle" class="w-5 h-5 text-green-500" />
          </div>
        </template>
        <div class="space-y-3">
          <div class="flex justify-between items-center">
            <span class="text-sm text-gray-600 dark:text-gray-400">Present Days</span>
            <span class="text-2xl font-bold text-green-600">18</span>
          </div>
          <div class="flex justify-between items-center">
            <span class="text-sm text-gray-600 dark:text-gray-400">Late Count</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <template #header>
            <div class="flex items-center justify-between">
              <h3 class="text-xl font-semibold flex items-center">
                <UIcon name="i-heroicons-megaphone" class="w-5 h-5 mr-2 text-blue-500" />
              ...
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  ...
                  <p class="text-sm text-red-700 dark:text-red-300 mt-1">
                    HRIS system will be down for maintenance this Saturday from 2:00 AM to 6:00 AM...
                  </p>
                  <p class="text-xs text-red-600 dark:text-red-400 mt-2">
                    August 5, 2025 • IT Department
                  </p>
                </div>
                <UBadge color="red" variant="soft" size="sm">High</UBadge>
              </div>
            </div>
              ...
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  ...
                  <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    We're excited to announce enhanced healthcare benefits and wellness programs...
                  </p>
                  <p class="text-xs text-blue-600 dark:text-blue-400 mt-2">
                    August 3, 2025 • HR Department
                  </p>
                </div>
                <UBadge color="blue" variant="soft" size="sm">Medium</UBadge>
              </div>
            </div>
              ...
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  <h4 class="font-semibold text-green-800 dark:text-green-200">
                    🏖️ Holiday Reminder - Independence Day
                  </h4>
                  <p class="text-sm text-green-700 dark:text-green-300 mt-1">
                    Reminder: August 26 is a national holiday. Office will be closed...
                  </p>
                  <p class="text-xs text-green-600 dark:text-green-400 mt-2">
                    August 1, 2025 • Admin
                  </p>
                </div>
                <UBadge color="green" variant="soft" size="sm">Low</UBadge>
              </div>
            </div>
          </div>
        </UCard>
        ...
        <UCard>
          ...
          >
            <template #date-data="{ row }">
              <span class="font-medium">{{ formatShortDate(row.date) }}</span>
            </template>
            <template #time_in-data="{ row }">
              <span class="text-green-600 dark:text-green-400 font-mono text-sm">
                {{ formatTime(row.time_in) }}
              </span>
            </template>
            <template #time_out-data="{ row }">
              <span class="text-red-600 dark:text-red-400 font-mono text-sm">
      ...
      <div class="space-y-6">
        ...
        <UCard>
          <template #header>
            <h3 class="text-xl font-semibold flex items-center">
              <UIcon name="i-heroicons-chart-pie" class="w-5 h-5 mr-2 text-purple-500" />
              Leave Balance
            </h3>
          </template>
          <div class="space-y-4">
        ...
        <UCard>
          <template #header>
            <h3 class="text-xl font-semibold flex items-center">
              <UIcon name="i-heroicons-calendar-days" class="w-5 h-5 mr-2 text-orange-500" />
              Upcoming Events
            </h3>
          </template>
          <div class="space-y-3">
          ...
          <template #header>
            <div class="flex items-center justify-between">
              <h3 class="text-lg font-semibold flex items-center">
                <UIcon name="i-heroicons-computer-desktop" class="w-5 h-5 mr-2 text-gray-500" />
                My Equipment
              </h3>
              <UButton
                size="sm"
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-800 rounded">
              <div class="flex items-center space-x-2">
                <UIcon name="i-heroicons-computer-desktop" class="w-4 h-4 text-gray-600" />
            ...
            <div class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-800 rounded">
              <div class="flex items-center space-x-2">
                <UIcon name="i-heroicons-device-phone-mobile" class="w-4 h-4 text-gray-600" />
